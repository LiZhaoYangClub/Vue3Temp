<template>
  <el-drawer v-model="drawerVisible" title="布局设置" size="300px">
    ...
    <el-divider class="divider" content-position="center">
      <SvgIcon name="layout" class="inline-block" />
      布局切换
    </el-divider>
    <div class="layout-box mb30">
      ...
      >
        ...
        >
          ...
          <SvgIcon v-if="layout == 'vertical'" name="selected" />
        </div>
      </el-tooltip>
      <el-tooltip
        effect="dark"
      ...
      >
        ...
        >
          ...
          <SvgIcon v-if="layout == 'classic'" name="selected" />
        </div>
      </el-tooltip>
      <el-tooltip
        effect="dark"
      ...
      >
        ...
        >
          <div class="layout-dark"></div>
          <div class="layout-content"></div>
          <SvgIcon v-if="layout == 'transverse'" name="selected" />
        </div>
      </el-tooltip>
      <el-tooltip
        effect="dark"
      ...
      >
        ...
        >
          ...
          <div class="layout-light"></div>
          <div class="layout-content"></div>
          <SvgIcon v-if="layout == 'columns'" name="selected" />
        </div>
      </el-tooltip>
    </div>
    ...
    <!-- 全局主题 -->
    <el-divider class="divider" content-position="center">
      <SvgIcon name="global" class="inline-block" />
      全局主题
    </el-divider>
    ...
    <!-- 界面设置 -->
    <el-divider class="divider" content-position="center">
      <SvgIcon name="setting" class="inline-block" />
      界面设置
    </el-divider>
    <div class="theme-item">
      <span>折叠菜单</span>
